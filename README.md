[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/2FwvLRoD)
[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/MZDEldfn)
...
* **Untuk menjalankan semua test yang diberikan pada tugas**:
  ...
  ```shell
  make test case="[case_*]"
  ```

  Contoh :
  ```shell
  make test case="[case_1]"
  ```
  Perintah diatas akan menjalankan `tugas_test`. Digunakan untuk mengecek salah satu test case
